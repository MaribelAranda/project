...
aa={'A':1, 'C': 2, 'D':3, 'E':4, 'F':5, 'G':6, 'H':7, 'I':8, 'K':9, 'L':10, 'M':11, 'N':12, 'P':13, 'Q':14,  'R':15, 'S':16, 'T':17, 'V':18, 'W':19, 'Y':20}
...
#Assign a vector position to each aa 
...
plt.title("Prediction_wholedata_pssm_(11wsize)")
plt.colorbar()
